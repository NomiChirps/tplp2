...
namespace {
// Yeah none of this is gonna happen. -nomi
bool log_filter_and_prefix_hook(absl::LogSeverity severity, const char* file,
                                int line, char** buf, int* buf_size) {
  return false;
}

void abort_hook(const char* file, int line, const char* buf_start,
