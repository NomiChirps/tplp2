...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "tplp/lv_tick_custom.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (lv_tick_custom_impl())    /*Expression evaluating to current system time in ms*/
